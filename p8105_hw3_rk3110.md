...
```
    ...
    ##    locationabbr locationdesc                n_obs
    ##    <chr>        <chr>                       <int>
    ##  1 AK           AK - Anchorage Municipality     4
    ##  2 AL           AL - Jefferson County           4
    ##  3 AR           AR - Pulaski County             4
    ##  4 AZ           AZ - Maricopa County            4
    ##  5 AZ           AZ - Pima County                4
    ##  6 CA           CA - Los Angeles County         4
    ##  7 CO           CO - Adams County               4
    ##  8 CO           CO - Arapahoe County            4
    ##  9 CO           CO - Denver County              4
    ## 10 CO           CO - Jefferson County           4
    ## # ... with 147 more rows
...
```
    ...
    ##    locationabbr locationdesc           n_obs
    ##    <chr>        <chr>                  <int>
    ##  1 AL           AL - Jefferson County      4
    ##  2 AL           AL - Mobile County         4
    ##  3 AL           AL - Tuscaloosa County     4
    ##  4 AR           AR - Benton County         4
    ##  5 AR           AR - Pulaski County        4
    ##  6 AR           AR - Washington County     4
    ##  7 AZ           AZ - Maricopa County       4
    ##  8 AZ           AZ - Pima County           4
    ##  9 AZ           AZ - Pinal County          4
    ## 10 CA           CA - Alameda County        4
    ## # ... with 292 more rows
